...
const Bullet: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div style={{ display: "flex", alignItems: "baseline", gap: 14 }}>
    ...
    <span style={{ fontSize: "clamp(17px, 2vw, 23px)", lineHeight: 1.45, fontWeight: 360 }}>
      {children}
    </span>
  </div>
);
...
const Week: React.FC<{ n: string; children: React.ReactNode }> = ({ n, children }) => (
  <div style={{ display: "flex", gap: 24, alignItems: "baseline" }}>
    ...
    <div style={{ fontSize: "clamp(16px, 1.9vw, 22px)", lineHeight: 1.4, fontWeight: 360, maxWidth: 520 }}>
      {children}
    </div>
  </div>
);
